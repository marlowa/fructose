...
Changes such that it builds with -std=c++17, coping with uncaught exception being deprecated.
Note that example 11 fails with C++11 and beyond because the hamcrest matcher code is still C++98.
